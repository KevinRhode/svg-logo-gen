...
{/* <polygon points="200,10 250,190 160,210" style="fill:lime;stroke:purple;stroke-width:1" /> */}
  ...
  describe('Initialize Stroke',()=>{
    it('should set Stroke', () => {
      ...
      expect(triangle.stroke).toBe(stroke);
    });
  });
  describe('Initialize Fill',()=>{
    it('should set Fill', () => {
      const fill = 'transparent';
      const triangle = new Triangle('','','','','','','transparent');  
  ...
  describe('Initialize StrokeWidth',()=>{
    it('should set StrokeWidth', () => {
      ...
      expect(triangle.strokeWidth).toBe(strokeWidth);
    });
  });
  ...
  {/* <circle cx="25" cy="75" r="20" */}
    ...
    describe('Initialize Stroke',()=>{
      it('should set Stroke', () => {
        ...
        expect(circle.stroke).toBe(stroke);
      });
    });
    describe('Initialize Fill',()=>{
      it('should set Fill', () => {
        const fill = 'transparent';
        const circle = new Circle('','','','','','','transparent');  
    ...
    describe('Initialize StrokeWidth',()=>{
      it('should set StrokeWidth', () => {
        ...
        expect(circle.strokeWidth).toBe(strokeWidth);
      });
    });
    describe('Initialize Type',()=>{
      it('should set Type', () => {
...
describe('Circle',() => {
  {/* <circle cx="25" cy="75" r="20" */}
    ...
    describe('Initialize Fill',()=>{
      it('should set Fill', () => {
        const fill = 'transparent';
        const rect = new Circle('','','','','','','transparent');  
    ...
    describe('Initialize StrokeWidth',()=>{
      it('should set StrokeWidth', () => {
        const strokeWidth = '5';
        const rect = new Circle('','','','','','','','5');  
        expect(rect.strokeWidth).toBe(strokeWidth);
      });
    });
    describe('Initialize Type',()=>{
      it('should set Type', () => {
